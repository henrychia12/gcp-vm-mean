...
sudo su - meanadm -c "git clone -b Developer https://github.com/Nboaram/TeamAPoolProjectBackend.git && git clone https://github.com/henrychia12/mean-pool-queue-script.git"
