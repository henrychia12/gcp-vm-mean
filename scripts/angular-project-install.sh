...
sudo su - meanadm -c "git clone -b Developer https://github.com/Nboaram/TeamAPoolProjectUI.git && git clone https://github.com/henrychia12/mean-pool-queue-script.git"
...
sudo cp /home/meanadm/mean-pool-queue-script/angular.service /etc/systemd/system
